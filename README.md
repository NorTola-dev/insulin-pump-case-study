...
[![Software Engineering](https://img.shields.io/badge/Domain-Software%20Engineering-blue.svg)]()
[![Safety Critical](https://img.shields.io/badge/System-Safety--Critical-red.svg)]()
[![Process Model](https://img.shields.io/badge/Process-V--Model%2FAgile-green.svg)]()
[![Git Workflow](https://img.shields.io/badge/Git-GitFlow-orange.svg)]()
...
Step 4: Create a Pull Request (PR)Go to NorTola-dev/insulin-pump-case-study on GitHub.Click Compare & pull request.Set Base: develop $\leftarrow$ Compare: feature/your-task-name.Request a review from the Git Lead to merge your work.
